...
// Data points for Garage Door Controller, version 1
const V1_GARAGE_DOOR_CONTROLLER_DATA_POINTS = {
    door_opening: 1, // boolean  |True:Open, False:Close
    powerOnStateSetting: 2, // Integer | 0 default when pairing/power up. Unknown usage
    doorSensorOpen: 3, // Boolean | True:Sensor Open, False: Sensor closed
    operTimer: 4, // Integer |  Timeout in (s) for close/open operation -> DP12 report with result 0 at timeout 
    autoCloseTimer: 5, // Integer | 3600 initially -  Open door supervision timer value
    openingTimesupervision: 11, // boolean - false -default at pairing/power up. Unknown usage
    operationResult: 12, // enum | 0:Open door timeout, 1: Incomplete after door_opening delay time, 2:Complete before door_opening expired
};
...
module.exports = {
    ...
    V1_GARAGE_DOOR_CONTROLLER_DATA_POINTS
};
